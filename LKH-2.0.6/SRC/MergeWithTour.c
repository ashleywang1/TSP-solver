...
GainType MergeWithTour()
{
    ...
    if (NewDimension == 0)
        return Distance == Distance_1 ? Cost1 : Cost1 / Precision;
    do {
    ...
    if (Cost1 < Cost2 ? !Improved1 : Cost2 < Cost1 ? !Improved2 :
        !Improved1 || !Improved2)
        return Distance == Distance_1 ? OldCost1 : OldCost1 / Precision;
    ...
    return Distance == Distance_1 ? (Cost1 <= Cost2 ? Cost1 : Cost2)
